...
const Aboutus = () => {
  return (
    <div className='bg-gradient-to-b min-h-screen mb-12 from-purple-300 to-white'>
         ...
         <p className='mx-auto w-[60%] mb-12 font-semibold border-b-2 pb-6'>{About.Aboutus}</p>
       <div className='md:grid flex flex-col grid-cols-2 w-[70%] mx-auto '>
        <h1 className='text-3xl font-bold'>Our story</h1>
        <p className='border-l-2 pl-6'>{About.ourstory}</p>
       </div>
       ...
       <h1 className='  text-3xl md:hidden font-bold  '>What We Offer</h1>
        ...
        <h1 className='hidden md:block text-right text-3xl font-bold border-l-2 '>What We Offer</h1>
       </div>
       <div className='w-[70%] flex flex-col gap-4 md:grid grid-cols-2 mx-auto'>
        <h1 className='text-3xl font-bold '>Our Vision</h1>
        <p className='border-l-2 pl-6'>{About.ourvision}</p>
       </div>
    </div>
  )
}
